    ...
    <section className="relative py-16 sm:py-20 bg-dark-slate-light/50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          <StatCounter end={84} prefix="+100" suffix="" label="Avg Point Increase Per Client" />
          <StatCounter end={2.4} prefix="$1.13" suffix="M+" label="In Negative Debt Deleted" decimals={1} />
          <StatCounter end={1200} suffix="1,200+" label="Members Served" />
